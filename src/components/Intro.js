    ...
    <>
      <div className="mb-20">
        <div className="grid grid-cols-2 gap-4">
          ...
          && (
          <>
            <button type="button" onClick={() => setIsEditing(true)} className="bg-blue-400 text-white p-2 rounded justify-self-end">Edit</button>
            <img src={image} alt="" className="justify-self-end max-w-sm" />
        ...
        <div className="my-10">
          ...
          <textarea
            ...
            className="block w-full p-2 my-4 border-2 rounded"
          />
          <button type="button" onClick={handleSubmit} className="bg-green-600 text-white p-2 mr-2 rounded">Submit</button>
          <button type="button" onClick={handleCancel} className="bg-neutral-400 text-white p-2 rounded">Cancel</button>
        </div>
        )}
      </div>
    </>
